            ...
            return (
              <div key={i}
                ...
                style={{
                  ...
                  border: showScope && isEdge ? `2px solid ${BUI_ORANGE}` : `1px solid ${covered ? p.color+"55" : t.border}`,
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    {p.isPilot && <div style={{ fontSize:9, color:p.color, background:`${p.color}15`, padding:"1px 4px", borderRadius:99, display:"inline-block", marginTop:2, border:`1px solid ${p.color}40`, fontFamily:CAL }}>PILOT</div>}
                  </div>
